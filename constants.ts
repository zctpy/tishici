// The detailed system prompt definition for the AI Persona
...
3.只输出完整的系统提示词，不要输出其他任何说明，除非你正在询问用户更多细节。
...
export const WELCOME_MESSAGE = "你好！我是提示词编写专家。请告诉我您希望我为您设计什么样的 AI 助手或任务，我会通过提问来完善细节，最终为您生成一份专业的系统提示词。";